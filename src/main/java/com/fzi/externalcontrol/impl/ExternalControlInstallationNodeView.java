...
public class ExternalControlInstallationNodeView
  ...
  private JButton createAddButton(final ExternalControlInstallationNodeContribution contribution) {
    JButton button = new JButton("Add new IP Host");
  ...
  private JPanel createMastersPanel(final ExternalControlInstallationNodeContribution contribution) {
    JPanel p = new JPanel();
    ...
    // TableColumn portColumn = table.getColumnModel().getColumn(3);
